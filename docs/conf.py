...
project = "RoboOrchardSchemas"
copyright = "2025, Horizon Robotics Developers"
author = "Horizon Robotics Developers"

# # The short X.Y version
version = robo_orchard_schemas.__version__
release = robo_orchard_schemas.__version__
...
html_context = {
    ...
    "versions_json_url": os.getenv(
        ...
        "https://horizonrobotics.github.io/robot_lab/robo_orchard/schemas/version.json",
    ),
}
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/HorizonRobotics/robo_orchard_schemas",
            "html": """
